...
// export default can only export one single file from a file . So when we have to export multiples things in a file we use named export (writing export before that thing (it could be any js variable or object))